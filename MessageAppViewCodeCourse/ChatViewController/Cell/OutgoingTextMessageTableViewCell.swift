...
class OutgoingTextMessageTableViewCell: UITableViewCell {
    ...
    func setupContraints(){
        ...
        NSLayoutConstraint.activate([
            ...
            self.messageTextLabel.topAnchor.constraint(equalTo: self.myMessageView.topAnchor,constant: 10),
            self.messageTextLabel.leadingAnchor.constraint(equalTo: self.myMessageView.leadingAnchor,constant: 10),
            self.messageTextLabel.trailingAnchor.constraint(equalTo: self.myMessageView.trailingAnchor,constant: -10),
            self.messageTextLabel.bottomAnchor.constraint(equalTo: self.myMessageView.bottomAnchor,constant: -10),
        ])
